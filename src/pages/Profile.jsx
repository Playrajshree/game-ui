...
const Profile = () => {
  ...
  return (
    <div className="h-full transition-colors duration-300 w-full p-6 bg-[#f1f5f9] text-black dark:bg-gray-800 dark:text-white dark:border-gray-700">
    <div className="w-full h-full p-6">
      <div className="flex justify-between items-center">
        <h2 className="text-xl font-bold text-gray-800 dark:text-white">Admin Profile</h2>
      </div>
      <div className="mt-4 text-center">
        <div className='border-[5px] shadow-md border-white dark:border-gray-400 w-32 h-32 mx-auto flex justify-center items-center rounded-full overflow-hidden'>
          <img
          className="w-32 h-32 mx-auto dark:border-gray-600 rounded-full"
      ...
      <div className="mt-6 space-y-2 text-sm text-left text-gray-700 dark:text-gray-300">
        ...
        <div><span className="font-medium">Joined:</span> {longDateFormater(admin.createdAt.split("T")[0])}</div>
      </div>
    </div>
  </div>
  )
